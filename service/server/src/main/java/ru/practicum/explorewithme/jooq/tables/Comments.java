...
public class Comments extends TableImpl<CommentsRecord> {
     ...
     */
    public final TableField<CommentsRecord, String> CONTENT = createField(DSL.name("content"), SQLDataType.VARCHAR(2200).nullable(false), this, "");

    /**
     * The column <code>public.comments.created</code>.
     */
    public final TableField<CommentsRecord, LocalDateTime> CREATED = createField(DSL.name("created"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column <code>public.comments.event_id</code>.
     */
    public final TableField<CommentsRecord, Long> EVENT_ID = createField(DSL.name("event_id"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    /**
     * The column <code>public.comments.status</code>.
     */
    public final TableField<CommentsRecord, String> STATUS = createField(DSL.name("status"), SQLDataType.VARCHAR(31).nullable(false), this, "");
    ...
    public List<ForeignKey<CommentsRecord, ?>> getReferences() {
        return Arrays.asList(Keys.COMMENTS__FK_COMMENTS_EVENT, Keys.COMMENTS__FK_COMMENTS_AUTHOR);
    }
    ...
    public EventsPath events() {
        if (_events == null)
            _events = new EventsPath(this, Keys.COMMENTS__FK_COMMENTS_EVENT, null);
    ...
    public UsersPath users() {
        if (_users == null)
            _users = new UsersPath(this, Keys.COMMENTS__FK_COMMENTS_AUTHOR, null);
